...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Log.i(Constants.TAG, "onCreate() method was invoked without a previous state");
        } else {
            Log.i(Constants.TAG, "onCreate() method was invoked with a previous state");
        }
    ...
    protected void onSaveInstanceState(Bundle savedInstanceState) {
        if (((CheckBox)findViewById(R.id.remember_me_checkbox)).isChecked()) {
            ...
            savedInstanceState.putString(Constants.USERNAME_EDIT_TEXT, ((EditText)findViewById(R.id.username_edit_text)).getText().toString());
            savedInstanceState.putString(Constants.PASSWORD_EDIT_TEXT, ((EditText)findViewById(R.id.password_edit_text)).getText().toString());
        }
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState.containsKey(Constants.USERNAME_EDIT_TEXT)) {
            ((EditText)findViewById(R.id.username_edit_text)).setText(savedInstanceState.get(Constants.USERNAME_EDIT_TEXT).toString());
        }
        if (savedInstanceState.containsKey(Constants.PASSWORD_EDIT_TEXT)) {
            ((EditText)findViewById(R.id.password_edit_text)).setText(savedInstanceState.get(Constants.PASSWORD_EDIT_TEXT).toString());
        }
    }
