...
public class BoundedServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.i(Constants.TAG, "onCreate() method was invoked");
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            Log.i(Constants.TAG, "onServiceConnected() method was invoked");
        ...
        public void onServiceDisconnected(ComponentName className) {
            Log.i(Constants.TAG, "onServiceDisconnected() method was invoked");
            boundedService = null;
            boundedServiceStatus = Constants.SERVICE_STATUS_UNBOUND;
        }
    };
